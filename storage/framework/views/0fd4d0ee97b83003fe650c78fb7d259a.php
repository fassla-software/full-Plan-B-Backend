<?php $__env->startSection('site_title', __('User Register')); ?>
    ...
    <section class="choose-account-area pat-100 pab-100 user_type_area">
        <div class="container">
            <div class="choose-account center-text">
                <h4 class="choose-account-title"><?php echo e(get_static_option('register_page_choose_role_title') ?? __('Choose a Role')); ?></h4>
                <p class="choose-account-para mt-2"><?php echo e(get_static_option('register_page_choose_role_subtitle') ?? __('Choose a role from below to continue signing up')); ?></p>
                <div class="choose-account-flex d-flex mt-4">
                    <div class="choose-account-single selected join_as_a_freelancer">
                        ...
                        <div class="choose-account-single-contents mt-3">
                            <h6 class="choose-account-single-contents-title"><?php echo e(get_static_option('register_page_choose_join_freelancer_title') ?? __('Join as a freelancer')); ?></h6>
                        </div>
                    </div>
                    <div class="choose-account-single join_as_a_client">
                        ...
                        <div class="choose-account-single-contents mt-3">
                            <h6 class="choose-account-single-contents-title"><?php echo e(get_static_option('register_page_choose_join_client_title') ?? __('Join as a Client')); ?></h6>
                        </div>
                    </div>
                </div>

                <div class="btn-wrapper mt-4">
                    <span class="btn-profile btn-bg-1 w-100 continue_to_info"><?php echo e(get_static_option('register_page_continue_button_title') ?? __('Continue')); ?></span>
                </div>
                ...
                <div class="col-lg-5">
                    <div class="login-wrapper">
                        <div class="login-wrapper-contents">
                            <h3 class="login-wrapper-contents-title"><?php echo e(__('Sign Up')); ?></h3>
                            ...
                            <form class="login-wrapper-form custom-form" method="post"
                                ...
                                <div class="input-flex-item">
                                    <div class="single-input mt-4">
                                        <label class="label-title mb-2"> <?php echo e(__('First Name')); ?> </label>
                                        <input class="form--control" type="text" name="first_name" id="first_name"
                                            placeholder="<?php echo e(__('Type First Name')); ?>">
                                    </div>
                                    <div class="single-input mt-4">
                                        <label class="label-title mb-2"> <?php echo e(__('Last Name')); ?> </label>
                                        <input class="form--control" type="text" name="last_name" id="last_name"
                                            placeholder="<?php echo e(__('Type Last Name')); ?>">
                                    </div>
                                </div>
                                <div class="single-input mt-4">
                                    <label class="label-title mb-2"> <?php echo e(__('User Name')); ?> </label>
                                    <input class="form--control" type="text" name="username" id="username"
                                        placeholder="<?php echo e(__('Type User Name')); ?>">
                                    <span id="user_name_availability"></span>
                                </div>
                                <div class="single-input mt-0">
                                    <label class="label-title mb-2"> <?php echo e(__('Email Address')); ?> </label>
                                ...
                                <div class="input-flex-item">
                                    <div class="single-input mt-0">
                                        <label class="label-title mb-2"> <?php echo e(__('Create Password')); ?> </label>
                                    ...
                                    <div class="single-input mt-0">
                                        <label class="label-title mb-2"> <?php echo e(__('Confirm Password')); ?> </label>
                                        <div class="single-input-inner">
                                            <input class="form--control" type="password" name="confirm_password"
                                                id="confirm_password" placeholder="<?php echo e(__('Confirm Password')); ?>">
                                            <div class="icon toggle-password">
                                                <div class="show-icon"> <i class="fas fa-eye-slash"></i> </div>
                                                <span class="hide-icon"> <i class="fas fa-eye"></i> </span>
                                            </div>
                                ...
                                <label class="form-check-label" for="toc_and_privacy">
                                    ...
                                    <a target="_blank" href="<?php echo e(url(get_static_option('toc_page_link') ?? '')); ?>"
                                       class="fw-bold"><?php echo e(__('Terms and Conditions')); ?></a> &amp;
                                    <a target="_blank" href="<?php echo e(url(get_static_option('privacy_policy_link') ?? '')); ?>"
                                       class="fw-bold"><?php echo e(__('Privacy Policy')); ?></a>
                                </label>

                                <?php if((!empty(get_static_option('site_google_captcha_enable')))): ?>
                                    <div class="col-md-12 my-3">
                                        <div class="g-recaptcha" id="recaptcha_element_register" data-sitekey="<?php echo e(get_static_option('recaptcha_site_key') ?? ''); ?>"></div>
                                        <?php if($errors->has('g-recaptcha-response')): ?>
                                            <span class="text-danger"><?php echo e($errors->first('g-recaptcha-response')); ?></span>
                                        <?php endif; ?>
                                    </div>
                                <?php endif; ?>
                                <button class="submit-btn w-100 mt-4 sign_up_now_button" type="submit"> <?php echo e(__('Sign Up Now')); ?> <span id="user_register_load_spinner"></span></button>
                                <span class="account color-light mt-3"> <?php echo e(__('Already have an account?')); ?> <a
                                        class="color-one" href="<?php echo e(route('user.login')); ?>"> <?php echo e(__('Login')); ?> </a>
                                </span>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="login-right">
                        <div class="global-slick-init login-slider nav-style-one dot-style-one white-dot slider-inner-margin"
                            ...
                            <?php if (isset($component)) { $__componentOriginal0a1f395f3d285ea6e86b8601eedd82be = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal0a1f395f3d285ea6e86b8601eedd82be = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.frontend.register.user-register-slider','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('frontend.register.user-register-slider'); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginal0a1f395f3d285ea6e86b8601eedd82be)): ?>
<?php $attributes = $__attributesOriginal0a1f395f3d285ea6e86b8601eedd82be; ?>
<?php unset($__attributesOriginal0a1f395f3d285ea6e86b8601eedd82be); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal0a1f395f3d285ea6e86b8601eedd82be)): ?>
<?php $component = $__componentOriginal0a1f395f3d285ea6e86b8601eedd82be; ?>
<?php unset($__componentOriginal0a1f395f3d285ea6e86b8601eedd82be); ?>
<?php endif; ?>
                        </div>
                    </div>
                </div>
            ...
            $(document).ready(function() {
                ...
                $(document).on('keyup', '#phones', function() {
                    ...
                    if (phoneRegex.test(phone) && phone != '') {
                        ...
                        $("#phone_availability").html(
                            "<span style='color: red;'><?php echo e(__('Enter valid phone number')); ?></span>"
                        );
                    }
                });
                            ...
                            data: {user_type:user_type,first_name: first_name,last_name:last_name,username:username,email:email,phone:phone,password:password,confirm_password:confirm_password,terms_condition:terms_condition,recaptchaResponse:recaptchaResponse},
                             ...
                             success: function(res) {
                                if (res.status == 'client') {
                                    window.location.href = "<?php echo e(route('client.profile')); ?>";
                                }
                                if (res.status == 'freelancer') {
                                    window.location.href = "<?php echo e(route('freelancer.profile')); ?>";
                                }
                             }
                     });
                })
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel_workspace\Fassla\planb\core\resources\views/frontend/user/user-register.blade.php ENDPATH**/ ?>