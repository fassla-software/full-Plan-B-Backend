...
class UserManageController extends Controller
{
    ...
    public function all_freelancers()
    {
        ...
        foreach ($all_users as $user) {
            ...
            $user->total_equipment =
                ...
                $user->vehicle_rental_count +
                $user->crane_rental_count;
        }
    ...
    public function edit_info(Request $request)
    {
        $request->validate([
            ...
            'edit_commas' => 'required|numeric',
            'edit_remaining_commas' => 'required|numeric',
        ]);
        ...
        Comma::updateOrCreate(
            ['user_id' => $request->edit_user_id],
            [
                'commas' => $request->edit_commas,
                'remaining_commas' => $request->edit_remaining_commas,
            ]
        );
