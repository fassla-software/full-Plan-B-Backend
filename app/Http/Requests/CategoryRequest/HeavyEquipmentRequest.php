...
class HeavyEquipmentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'data_certificate_image' => 'required|image',
            'driver_license_front_image' => 'required|image',
            'driver_license_back_image' => 'required|image',
            'additional_equipment_images' => 'required|array|max:5',
            ...
            'tractor_license_front_image' => 'required_if:equipment_type,agriculturalTractor|image',
            'tractor_license_back_image' => 'required_if:equipment_type,agriculturalTractor|image',
            ...
            'flatbed_license_front_image' => 'required_if:equipment_type,equipmentTransportFlatbed|image',
            'flatbed_license_back_image' => 'required_if:equipment_type,equipmentTransportFlatbed|image',
