...
class StoreEquipmentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'data_certificate_image' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif,svg', 'max:2048'],
            'driver_license_front_image' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif,svg', 'max:2048'],
            'driver_license_back_image' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif,svg', 'max:2048'],
            'tractor_license_front_image' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif,svg', 'max:2048'],
            'tractor_license_back_image' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif,svg', 'max:2048'],
            'flatbed_license_front_image' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif,svg', 'max:2048'],
            'flatbed_license_back_image' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif,svg', 'max:2048'],
            'additional_equipment_images' => ['nullable', 'array'],
            'additional_equipment_images.*' => ['image', 'mimes:jpeg,png,jpg,gif,svg', 'max:2048'],
