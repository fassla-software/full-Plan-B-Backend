...
class UpdateEquipmentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'data_certificate_image' => ['nullable', 'string', 'max:255'],
            'driver_license_front_image' => ['nullable', 'string', 'max:255'],
            'driver_license_back_image' => ['nullable', 'string', 'max:255'],
            'tractor_license_front_image' => ['nullable', 'string', 'max:255'],
            'tractor_license_back_image' => ['nullable', 'string', 'max:255'],
            'flatbed_license_front_image' => ['nullable', 'string', 'max:255'],
            'flatbed_license_back_image' => ['nullable', 'string', 'max:255'],
            'additional_equipment_images' => ['nullable', 'array'],
            'additional_equipment_images.*' => ['string', 'max:255'],
