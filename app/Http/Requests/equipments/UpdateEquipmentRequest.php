...
class UpdateEquipmentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'data_certificate_image' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif,svg'],
            'driver_license_front_image' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif,svg'],
            'driver_license_back_image' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif,svg'],
            'tractor_license_front_image' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif,svg'],
            'tractor_license_back_image' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif,svg'],
            'flatbed_license_front_image' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif,svg'],
            'flatbed_license_back_image' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif,svg'],
            'additional_equipment_images' => ['nullable', 'array'],
            'additional_equipment_images.*' => ['image', 'mimes:jpeg,png,jpg,gif,svg'],
