            ...
            <form action="{{ route('admin.user.info.edit') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body" id="edit_user_details">
                    <div class="edit_user_detailsInfo">
                        ...
                        <x-form.text :title="__('First Name')" :type="'text'" :name="'edit_first_name'" :id="'edit_first_name'"
                            :placeholder="__('Enter first name')" />
                        <x-form.text :title="__('Last Name')" :type="'text'" :name="'edit_last_name'" :id="'edit_last_name'"
                            :placeholder="__('Enter last name')" />
                        <x-form.text :title="__('User Name')" :type="'text'" :name="'edit_username'" :id="'edit_username'"
                            :placeholder="__('Enter last name')" />
                        ...
                        <x-form.text :title="__('Phone')" :type="'number'" :name="'edit_phone'" :id="'edit_phone'"
                            :placeholder="__('Enter phone number')" />

                        <span id="phone_availability"></span>
                        <x-form.text :title="__('Commas')" :type="'number'" :name="'edit_commas'" :id="'edit_commas'"
                            :placeholder="__('Enter Commas number')" />
                        <span id="commas_availability"></span>
                        <x-form.text :title="__('Remaining Commas')" :type="'number'" :name="'edit_remaining_commas'" :id="'edit_remaining_commas'"
                            :placeholder="__('Enter Remaining Commas number')" />
                        <span id="remaining_commas_availability"></span>
                        ...
                        <div class="single-input mb-3">
                            ...
                            <select name="edit_state" id="edit_state"
                                class="form-control get_country_state state_select2">
