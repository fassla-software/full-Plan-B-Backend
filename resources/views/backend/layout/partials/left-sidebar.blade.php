    ...
    <div class="dashboard__left__main">
            ...
            <ul class="dashboard__bottom__list dashboard-list">
                ...
                @if (moduleExists('PluginManage'))
                    <li
                        ...
                        <ul class="submenu">
                            <li
                                class="dashboard__bottom__list__item @if (request()->routeIs(['admin.plugin.manage.all'])) selected @endif">
                                <a href="{{ route('admin.plugin.manage.all') }}"> {{ __('All Plugins') }} </a>
                            </li>
                            <li
                                class="dashboard__bottom__list__item @if (request()->routeIs(['admin.plugin.manage.new'])) selected @endif">
                                <a href="{{ route('admin.plugin.manage.new') }}"> {{ __('Add Plugin') }} </a>
                            </li>
                        </ul>
                    </li>
                @endif
                @if (moduleExists('Offers'))
                    <li class="dashboard__bottom__list__item @if (request()->routeIs([
                            'admin.offers.index',
                            'admin.offers.paginate.data',
                            'admin.offers.search',
                            'admin.offer.info.edit',
                            'admin.offers.delete',
                        ])) active @endif">
                        <a href="{{ route('admin.offers.index') }}"> <i class="fa-solid fa-handshake"></i>
                            {{ __('Offers Manage') }} </a>
                    </li>
                @endif
                ...
                @foreach ($all_modules_route as $index => $externalMenu)
                    ...
                    @foreach ($externalMenu as $key => $individual_menu_item)
                        @php
                            ...
                            if (
                                array_key_exists('permissions', $convert_to_array) &&
                                !is_array($convert_to_array['permissions'])
                            ) {
                        ...
                        @if (count($externalMenu) > 1)
                            @if ($key === 0)
                                <li
                                    class="dashboard__bottom__list__item has-children @if (in_array(\Request::route()->getName(), $activeRoutes)) active open @endif">
                            @endif
                            ...
                            @if (empty($convert_to_array['parent']) && !$flag)
                                ...
                                <a href="javascript:void(0)">
                                    ...
                                    <span class="icon_title">{{ $convert_to_array['label'] }} <span
                                            class="badge bg-danger">{{ __('Plugin') }}</span> </span>
                                </a>
                                <ul class="submenu" style=" @if (in_array(\Request::route()->getName(), $activeRoutes)) display:block; @endif">
                            @endif
                            @if ($key !== 0 && $flag)
                                <li
                                    class="dashboard__bottom__list__item  @if (request()->routeIs($routeName) == $routeName) selected @endif">
        ...
        @else
            <li class="dashboard__bottom__list__item @if (request()->routeIs($routeName)) active open @endif">
                <a href="{{ route($routeName) }}"> <i class="{{ $icon }}"></i>
                    {{ $convert_to_array['label'] }} <span class="badge bg-danger">{{ __('Plugin') }}</span> </a>
            </li>
            @endif
            @endforeach
            @endforeach
            ...
            <li
                ...
                <ul class="submenu">
                    ...
                    <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.category.enable.disable.settings'])) selected @endif">
                        <a href="{{ route('admin.category.enable.disable.settings') }}">
                            {{ __('Enable Disable Section') }} </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.length.all'])) active @endif">
                <a href="{{ route('admin.length.all') }}"> <i
                        class="fa-regular fa-clock"></i>{{ __('Job & Project Length') }}</a>
            </li>

            <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.experience.level.all'])) active @endif">
                <a href="{{ route('admin.experience.level.all') }}"> <i
                        class="fa-solid fa-user-gear"></i>{{ __('Experience Level') }}</a>
            </li>
                ...
                <ul class="submenu">
                    ...
                    @can('project-history-list')
                        <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.project.history'])) selected @endif">
                            <a href="{{ route('admin.project.history') }}"> {{ __('Service History') }} </a>
                        </li>
                        <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.project.approval.settings'])) selected @endif">
                            <a href="{{ route('admin.project.approval.settings') }}"> {{ __('Auto Approval Settings') }}
                            </a>
                        </li>
                    @endcan
                </ul>
            ...
            @can('transaction-manage')
                <li
                    ...
                    <ul class="submenu">
                        <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.commission.settings'])) selected @endif">
                            <a href="{{ route('admin.commission.settings') }}">
                                {{ __('Admin Commission Settings') }} </a>
                        </li>
                        <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.transaction.fee.settings'])) selected @endif">
                ...
                <ul class="submenu">
                    @can('order-list')
                        ...
                        <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.order.enable.disable.description.settings'])) selected @endif">
                            <a href="{{ route('admin.order.enable.disable.description.settings') }}">
                                {{ __('Order Description Settings') }} </a>
                        </li>
                        <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.order.enable.disable.milestone.settings'])) selected @endif">
                            <a href="{{ route('admin.order.enable.disable.milestone.settings') }}">
                                {{ __('Order Milestone Settings') }} </a>
                        </li>
            ...
            <li
                class="dashboard__bottom__list__item has-children @if (request()->is('admin/user-report*')) active open show @endif">
            ...
            <li
                class="dashboard__bottom__list__item has-children @if (request()->is('admin/newsletter*')) active open show @endif">
            ...
            @can('blog-list')
                <li
                    class="dashboard__bottom__list__item has-children @if (request()->is('admin/blog*')) active open show @endif">
            ...
            <li
                class="dashboard__bottom__list__item has-children @if (request()->is('admin/notification/*')) active open show @endif">
                    ...
                    @can('notification-list')
                        <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.notification.all'])) active @endif">
                            <a href="{{ route('admin.notification.all') }}"> <i
                                    class="fa-solid fa-bell"></i>{{ __('All Notifications') }}</a>
                        </li>
                        <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.notification.settings'])) active @endif">
                            <a href="{{ route('admin.notification.settings') }}"> <i
                                    class="fa-solid fa-bell"></i>{{ __('Notification Settings') }}</a>
                        </li>
                    @endcan
                </ul>
            </li>
            ...
            <li
                class="dashboard__bottom__list__item has-children @if (request()->is('admin/payment-settings*')) active open show @endif">
            ...
            <li
                class="dashboard__bottom__list__item has-children @if (request()->is('admin/plugins*')) active open show @endif">
            ...
            <li
                class="dashboard__bottom__list__item has-children @if (request()->is('admin/additional-settings*')) active open show @endif">
            ...
            <li
                class="dashboard__bottom__list__item has-children @if (request()->is('admin/email-template*')) active open show @endif">
